  ...
  return (
    <div className="h-10 text-white bg-blue-500 max-lg:px-5 max-lg:h-16 max-[573px]:px-0">
      <div className="flex justify-between h-full max-lg:flex-col max-lg:justify-center max-lg:items-center max-w-screen-2xl mx-auto px-12 max-[573px]:px-0">
        ...
        {/* Auth links align right implicitly by using empty space or flex-end. 
            Since there's no left element, justify-between handles spacing. 
            If we only have one element (ul), justify-end is better, but this is the exact original. */}
        
        {/* Empty left gap or justify-between spacer */}
        <div></div>
            ...
            <>
              ...
              <li className="flex items-center">
                <button
                  ...
                  className="flex items-center gap-x-2 font-semibold hover:text-gray-200"
                >
                  <FaRegUser className="text-white" />
                  <span>Log out</span>
                </button>
